...
with(document.test)
   ...
   if (answ.charAt(2)=="1") {T3.value=" + "} else {T3.value=" - "};
    ...
    document.querySelector('.test-result').innerHTML = nok;
}
...
<center><b class="test-name">Тест по JavaScript</b></center><br/><br/>
...
<INPUT onclick="check_me()" class="test-checking" type="button" value="Показать результат"/>&nbsp;&nbsp;&nbsp;&nbsp; 
<INPUT type="reset" value="Сбросить ответы"/> 
</CENTER>  
<p class="test-result" style="display:none;"></p>      
</form> 
    </div>
</main>
<? else : ?>
